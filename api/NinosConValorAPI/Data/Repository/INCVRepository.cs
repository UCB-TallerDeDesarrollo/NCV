...
namespace NinosConValorAPI.Data.Repository
{
    public interface INCVRepository
    {
        ...
        Task<BiometricsEntity> GetBiometricsAsync(int kidId, int biometricsId);
        ...
        Task<ContactEntity> GetContactAsync(int kidId, int contactId);
        ...
        Task<bool> UpdateAssetCategoryAsync(int categoryId, AssetCategoryEntity assetCategory);
