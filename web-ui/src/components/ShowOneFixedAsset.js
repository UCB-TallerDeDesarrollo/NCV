...
export function ShowFixedAsset () {
  ...
  useEffect(() => {
    axios
      .get(`https://ncv-api.herokuapp.com/api/fixedAssets/${fixedAssetId}`)
      .then(response => {
        ...
        <ul>
          <Card style={{ minHeight: '80vh' }}>
            <li>
              ...
              />
              <CardContent>
                <h4>DESCRIPCIÓN: {fixedAsset.description}</h4> <br></br>
                <h4>FECHA DE ENTRADA: {fixedAsset.entryDate.split('T')[0]}</h4>
                <br></br>
