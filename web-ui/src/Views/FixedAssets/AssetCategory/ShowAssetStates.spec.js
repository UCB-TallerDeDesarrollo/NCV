...
import ShowAssetStates from './ShowAssetCategory'
...
const getAssetStatesUrl =process.env.REACT_APP_BACKEND_URL + '/api/assetStates'  
const oneAssetStatesUrl =process.env.REACT_APP_BACKEND_URL + '/api/assetStates/1'   
