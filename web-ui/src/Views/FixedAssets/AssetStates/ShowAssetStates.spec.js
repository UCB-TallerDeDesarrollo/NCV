...
const getAssetStatesUrl ='https://ncv-api-dev.azurewebsites.net/api/assetStates'  
const oneAssetStatesUrl ='https://ncv-api-dev.azurewebsites.net/api/assetStates/1'   
